...
public class EmployeeStreamDemo {
    ...
    public static void main(String[] args) {
        ...
        //method1();
        System.out.println("Employee:"+employeeList.stream().collect(Collectors.groupingBy(Employee::getGender,Collectors.counting())));
        // Query 2 : Print the name of all departments in the organization?
        Set<String> dept= new HashSet<>();
        employeeList.stream().map(emp->dept.add(emp.getDepartment()));
    ...
    public static void method9() {
        ...
        Optional<Employee> seniorMostEmployeeWrapper= employeeList.stream().min(Comparator.comparing(Employee::getYearOfJoining));
